...
import { checkRegularClientChanges } from "./clients.mjs"
...
export function buildChangePlan(connections, domain, platformConfig) {
  const clientPlan = checkRegularClientChanges(domain, platformConfig)
...
export function displayChangePlan(plan) {
  ...
  const items = [
    { name: "Regular Web Application", ...plan.client },
